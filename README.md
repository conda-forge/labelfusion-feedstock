...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/labelfusion-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12307&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/labelfusion-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `labelfusion` can be installed with:

```
conda install labelfusion
```

It is possible to list all of the versions of `labelfusion` available on your platform with:
